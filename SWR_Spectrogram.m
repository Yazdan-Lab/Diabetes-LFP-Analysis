...
%% stats
% Time to squish the stats into a format that the anova function wants
Spec.DB2CtxVals = squeeze(mean(mean(Spec.DB2Ctx(5:12,:,:),2),1));
Spec.DB4CtxVals = squeeze(mean(mean(Spec.DB4Ctx(5:12,:,:),2),1));
Spec.DBDB2CtxVals = squeeze(mean(mean(Spec.DBDB2Ctx(5:12,:,:),2),1));
Spec.DBDB4CtxVals = squeeze(mean(mean(Spec.DBDB4Ctx(5:12,:,:),2),1));

Spec.DB2PyrVals = squeeze(mean(mean(Spec.DB2Pyr(5:12,:,:),2),1));
Spec.DB4PyrVals = squeeze(mean(mean(Spec.DB4Pyr(5:12,:,:),2),1));
Spec.DBDB2PyrVals = squeeze(mean(mean(Spec.DBDB2Pyr(5:12,:,:),2),1));
Spec.DBDB4PyrVals = squeeze(mean(mean(Spec.DBDB4Pyr(5:12,:,:),2),1));

Spec.DB2SLMVals = squeeze(mean(mean(Spec.DB2SLM(5:12,:,:),2),1));
Spec.DB4SLMVals = squeeze(mean(mean(Spec.DB4SLM(5:12,:,:),2),1));
Spec.DBDB2SLMVals = squeeze(mean(mean(Spec.DBDB2SLM(5:12,:,:),2),1));
Spec.DBDB4SLMVals = squeeze(mean(mean(Spec.DBDB4SLM(5:12,:,:),2),1));
