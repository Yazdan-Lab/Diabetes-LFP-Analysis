...
AD(31).name  = 'AD42'; AD(31).L_cor = 0;  AD(31).R_chn = {[6],[11],[16]};AD(31).L_chn = {[], [], []};
AD(32).name  = 'AD43'; AD(32).L_cor = 0;  AD(32).R_chn = {[2 2],[7 7],[11 11]};AD(32).L_chn = {[], [], []};

DB(1).name  = 'DB1'; DB(1).L_cor = 0;  DB(1).R_chn = {[5 5],[10 10],[14 14]};   DB(1).L_chn = {[5 5], [10 10], [13 13]};
DB(2).name  = 'DB2'; DB(2).L_cor = 0;  DB(2).R_chn = {[5 5],[9 9],[13 13]};     DB(2).L_chn = {[5 5], [9 9], [13 13 ]};
DB(3).name  = 'DB3'; DB(3).L_cor = 0;  DB(3).R_chn = {[2 2],[8 8],[12 12]};     DB(3).L_chn = {[5 5], [10 10], [14 14 ]};
DB(4).name  = 'DB4'; DB(4).L_cor = 0;  DB(4).R_chn = {[5 5],[9 9],[13 13]};     DB(4).L_chn = {[5 5], [10 10], [14 14 ]};
DB(5).name  = 'DB5'; DB(5).L_cor = 0;  DB(5).R_chn = {[2 2 2],[8 8 8],[12 12 12]};     DB(5).L_chn = {[2 2 2], [8 8 8], [12 12 12]};
DB(6).name  = 'DB6'; DB(6).L_cor = 0;  DB(6).R_chn = {[2 2],[8 8],[12 12]};     DB(6).L_chn = {[2 2], [8 8], [12 12]};
DB(7).name  = 'DB7'; DB(7).L_cor = 0;  DB(7).R_chn = {[2 2],[8 8],[14 14]};     DB(7).L_chn = {[], [], []};
DB(8).name  = 'DB8'; DB(8).L_cor = 0;  DB(8).R_chn = {[2 2],[7 7],[14 14]};     DB(8).L_chn = {[2 2], [6 6], [12 12]};
DB(9).name  = 'DB9'; DB(9).L_cor = 0;  DB(9).R_chn = {[2 2],[6 6],[11 11]};     DB(9).L_chn = {[], [], []};
DB(10).name  = 'DB10'; DB(10).L_cor = 0;  DB(10).R_chn = {[2 2],[7 7],[13 13]};     DB(10).L_chn = {[], [], []};
DB(11).name  = 'DB11'; DB(11).L_cor = 0;  DB(11).R_chn = {[2 2],[7 7],[14 14]};     DB(11).L_chn = {[], [], []};
DB(12).name  = 'DB12'; DB(12).L_cor = 0;  DB(12).R_chn = {[2 2],[7 7],[14 14]};     DB(12).L_chn = {[], [], []};

DBDB(2).name  = 'DBDB2'; DBDB(2).L_cor = 0;  DBDB(2).R_chn = {[2 2],[8 8],[12 12]};     DBDB(2).L_chn = {[5 5], [10 10], [14 14 ]};
DBDB(3).name  = 'DBDB3'; DBDB(3).L_cor = 0;  DBDB(3).R_chn = {[2],[8],[12]};     DBDB(3).L_chn = {[2], [8], [14]};
DBDB(4).name  = 'DBDB4'; DBDB(4).L_cor = 0;  DBDB(4).R_chn = {[2 2 2],[8 8 8],[12 12 12]};     DBDB(4).L_chn = {[5 5 5], [10 10 10], [14 14 14]};
DBDB(5).name  = 'DBDB5'; DBDB(5).L_cor = 0;  DBDB(5).R_chn = {[2 2],[7 7],[11 11]};     DBDB(5).L_chn = {[2 2], [8 8], [14 14]};
DBDB(6).name  = 'DBDB6'; DBDB(6).L_cor = 0;  DBDB(6).R_chn = {[2 2],[8 8],[14 14]};     DBDB(6).L_chn = {[5 5], [10 10], [15 15]};
DBDB(7).name  = 'DBDB7'; DBDB(7).L_cor = 0;  DBDB(7).R_chn = {[4 2 2],[11 9 9],[16 13 13]};     DBDB(7).L_chn = {[], [], []};
DBDB(8).name  = 'DBDB8'; DBDB(8).L_cor = 0;  DBDB(8).R_chn = {[4 4],[10 10],[14 14]};     DBDB(8).L_chn = {[], [], []};
DBDB(9).name  = 'DBDB9'; DBDB(9).L_cor = 0;  DBDB(9).R_chn = {[2],[7],[12]};     DBDB(9).L_chn = {[2], [6], [10]};
DBDB(10).name  = 'DBDB10'; DBDB(10).L_cor = 0;  DBDB(10).R_chn = {[2 2 2],[9 9 9],[14 14 14]};     DBDB(10).L_chn = {[], [], []};
DBDB(11).name  = 'DBDB11'; DBDB(11).L_cor = 0;  DBDB(11).R_chn = {[2 2 2],[8 8 8],[13 13 13]};     DBDB(11).L_chn = {[], [], []};
DBDB(12).name  = 'DBDB12'; DBDB(12).L_cor = 0;  DBDB(12).R_chn = {[2 2],[9 9],[14 14]};     DBDB(12).L_chn = {[], [], []};
DBDB(13).name  = 'DBDB13'; DBDB(13).L_cor = 0;  DBDB(13).R_chn = {[2 2],[7 7],[14 14]};     DBDB(13).L_chn = {[], [], []};
DBDB(14).name  = 'DBDB14'; DBDB(14).L_cor = 0;  DBDB(14).R_chn = {[1 1],[6 6],[13 13]};     DBDB(14).L_chn = {[], [], []};
...
SpkInfo{13,1} = 'DB';   SpkInfo{13,2} = DB;
SpkInfo{14,1} = 'DBDB';   SpkInfo{14,2} = DBDB;
