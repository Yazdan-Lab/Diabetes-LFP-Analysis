...
ageLabs =   [label.DB2age;   label.DB4age;   label.DBDB2age;   label.DBDB4age];
treatLabs = [label.DB2treat; label.DB4treat; label.DBDB2treat; label.DBDB4treat];
% Power
power_vals = [rip.DB2(:,7); rip.DB4(:,7); rip.DBDB2(:,7); rip.DBDB4(:,7)];
[powerP,powerT,power_stats] = anovan(power_vals, {treatLabs, ageLabs},'model','interaction');% ,'display','off');
...
[durP,durT,dur_stats] = anovan(dur_vals, {treatLabs, ageLabs},'model','interaction'); % ,'display','off');
